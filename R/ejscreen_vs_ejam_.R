...
#' @param varname the 1 indicator to examine, a colname in an output table of ejamit(), such as "pop"
#' @param info optional, vector of the names of the metrics to use in the comparison, i.e., which of the named elements of vs
