...
-   EJAM powers EJScreen's Multisite Tool, for providing public access to multisite reports. The EJScreen Multisite Tool can be reached from the [EJScreen website](https://www.epa.gov/ejscreen) or [EJScreen Mapping application](https://ejscreen.epa.gov/mapper/).
...
If you have questions or comments, please contact the EJScreen team in EPA's OEJECR, and for technical questions contact Mark Corrales (corrales.mark\@epa.gov).
